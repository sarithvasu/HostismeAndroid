...
public class DBConstant {
    ...
    public static final String CREATE_ORDERITEM= "CREATE TABLE "+TABLE_NAME_ORDERITEM
            +" ("+COLUMN_NAME_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+COLUMN_NAME_CAT_NAME+" TEXT, "+COLUMN_NAME_SUB_CAT+" TEXT, "+
            COLUMN_NAME_MENU_ITEM_ID+" INTEGER, "+COLUMN_NAME_ITEM_NAME+" TEXT, "+COLUMN_NAME_ITEM_INGRE+" TEXT,"+
            COLUMN_NAME_ITEM_PRICE+" REAL, "+COLUMN_NAME_ITEM_QTY+" INTEGER,"+COLUMN_NAME_FLAG+" INTEGER)";
